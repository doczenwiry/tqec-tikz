...
\begin{document}
	...
	% Clique of four spiders (4 Red). [Symmetric with 4 Blue]
	\ZXGraph[labels=show]{
		\Node[type=X, plane=U, identifier=S1]{( 0, 0)}
		\Node[type=X, plane=U, identifier=S2]{( 0,-1)}
		\Node[type=X, plane=U, identifier=S3]{( 1, 0)}
		\Node[type=X, plane=U, identifier=S4]{( 1,-1)}
	...
	\ZXGraph[labels=show]{
		...
		\Node[type=X, plane=U, identifier=S2]{( 0,-1)}
		\Node[type=X, plane=U, identifier=S3]{( 1, 0)}
		\Node[type=Z, plane=U, identifier=S4]{( 1,-1)}
