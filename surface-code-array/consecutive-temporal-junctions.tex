...
\makeatletter
	...
	% Controls the offset of the 2-qubit stabilizers along the perimeter 
...
\begin{document}
	...
	\SurfaceCodeArray[order = 5]{
		\LogicalQubit[order=1, orderW=5, position={(0,4)}]{}
	}
	...
	\SurfaceCodeArray[order = 5]{
		\LogicalQubit[order=1, position={(0,4)}]{}
		\LogicalQubit[order=1, orderH=5, position={(4,0)}]{}
		\LogicalQubit[order=1, position={(8,4)}]{}
	}
