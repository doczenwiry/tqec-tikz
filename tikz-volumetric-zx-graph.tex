...
\tikzset{
	...
	zx/graph/rotationX/.initial=58,   % Rotation along x-axis for tikz-3dplot
	zx/graph/rotationZ/.initial=112,  % Rotation along z-axis for tikz-3dplot
	% Node parameters
	zx/node/kind/.initial=UUU,
	zx/node/type/.initial=U,
	zx/node/plane/.initial=U,
	zx/node/label/.initial=,
	zx/node/visibility/.initial=plain, % controls node opacity; plain, faint or ghost
	...
	zx/edge/visibility/.initial=plain, % controls edge opacity; plain, faint or ghost
...
\newcommand{\Node}[2][]{
	\begingroup
		...
		\def\NodeLabel{\pgfkeysvalueof{/tikz/zx/node/label}}
		\def\NodeStyle{\pgfkeysvalueof{/tikz/zx/node/style}}
		\def\NodeVisibility{\pgfkeysvalueof{/tikz/zx/node/visibility}}
		...
		\ifthenelse{\equal{\NodeLabel}{} \and \equal{\ShowNodeLabels}{all}}{
			\def\NodeLabel{\Identifier}
		}{
			% Do nothing
		}
		...
		\IfStrEqCase{\NodeVisibility}{
			{plain}{\def\NodeOpacity{1.000}}
			{faint}{\def\NodeOpacity{0.200}}
			{ghost}{\def\NodeOpacity{0.025}}
		}
		...
		\IfStrEqCase{\NodeStyle}{
			{zx}{
				...
				\ifthenelse{\equal{\NodeType}{O}}{
					\fill[\NodeType, opacity = \NodeOpacity] (node\Identifier) circle (2pt);
				}{
					\fill[\NodeType, opacity = \NodeOpacity] (node\Identifier) circle (3pt);
				}
			
				% Draw plane constraint
				\ifthenelse{\not\equal{\NodeType}{O}}{
					\draw[\NodePlane, line width = 1pt, opacity = \NodeOpacity] (node\Identifier) circle (4pt);
				}{
					% Do not draw
				}
			}
			{bg}{
				...
				\ifthenelse{\equal{\NodeKind}{XXX} \or \equal{\NodeKind}{ZZZ}}{
					...
					\fill[\ColorX, rounded corners = 0.25pt, opacity = \NodeOpacity]
					...
					\fill[\ColorY, rounded corners = 0.25pt, opacity = \NodeOpacity]
					...
					\fill[\ColorZ, rounded corners = 0.25pt, opacity = \NodeOpacity]
					...
					\fill[\ColorX, opacity = \NodeOpacity] ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset    , -\CubeOffset    )}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset    )}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset    , -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- cycle;
			
					\fill[\ColorY, opacity = \NodeOpacity] ([shift={(-\CubeOffset    , -\CubeOffset + \CubeSize, -\CubeOffset    )}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset    )}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- ([shift={(-\CubeOffset    , -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- cycle;
			
					\fill[\ColorZ, opacity = \NodeOpacity] ([shift={(-\CubeOffset    , -\CubeOffset    , -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset    , -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- ([shift={(-\CubeOffset    , -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
						  -- cycle;
				...
				\draw[border, opacity = \NodeOpacity]
						 ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset            , -\CubeOffset            )}] node\Identifier)
					  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset            )}] node\Identifier)
					  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize, -\CubeOffset + \CubeSize)}] node\Identifier)
					  -- ([shift={(-\CubeOffset + \CubeSize, -\CubeOffset            , -\CubeOffset + \CubeSize)}] node\Identifier)
		...
		\ifthenelse{\equal{\ShowNodeLabels}{show}}{
			\node[white, scale=0.25] at (node\Identifier) {\Large\tt \NodeLabel};
		}{
			% Do nothing
		}
...
\newcommand{\Edge}[3][]{
	\begingroup
		...
		\def\EdgeVisibility{\pgfkeysvalueof{/tikz/zx/edge/visibility}}

		\IfStrEqCase{\EdgeVisibility}{
			{plain}{\def\EdgeOpacity{1.000}}
			{faint}{\def\EdgeOpacity{0.200}}
			{ghost}{\def\EdgeOpacity{0.025}}
		}

		\draw[edge, white, line width = 2.5pt, opacity = \EdgeOpacity] (node#2) -- (node#3);
		\draw[edge, \EdgeType, opacity = \EdgeOpacity] (node#2) -- (node#3);
		\draw[edge, thick, \EdgeAxis, opacity = \EdgeOpacity] (node#2) -- (node#3);
	\endgroup
}
